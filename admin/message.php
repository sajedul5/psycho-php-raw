...
<!--comment reply --><?php include_once('mailsend.php' ); ?>
        <?php
            if(isset($_GET['reply'])){
              $reply_id = $_GET['reply'];
              ...
              if(mysqli_num_rows($reply_check_run) > 0){
                ...
                if(isset($_POST['reply'])){
                  ...
                  if(mysqli_query($con, $insert_message_query)){
                    ...
                    sendEmail("sajedul.idb@gmail.com",$email,"1me!",$message);
                  }
                  else {
        ...
        <form class="" method="post">
          <?php
           ...
           <div class="input-group input-group-lg">
             ...
             data-validation="required email" value="<?php echo $_GET['email']; ?>" >
           </div>
           </div>
              <div class="form-group">
    ...
    <table class="table table-hover table-striped text-muted">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="message.php?reply=<?php echo $contact_id; ?>&email=<?php echo $email; ?>"><i class="fa fa-reply text-info"></i></a></td>

         ...
         <?php
           if(isset($_GET['approve'])){
             ...
             if(mysqli_query($con, $approve_query)){
               ...
               $error ="Comment has not Approved";
             }
           }
            ...
            if(isset($_GET['reply'])){
              ...
              if(mysqli_num_rows($reply_check_run) > 0){
                ...
                if(isset($_POST['reply'])){
                  ...
                  VALUES ('$date','1me!','admin@gmail.com','$reply_id','un.jpg','$comment','pending')";
    ...
    <table class="table table-hover table-striped text-muted">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="comments.php?approve=<?php echo $id; ?>"><i class="fa fa-check text-success"></i></a></td>
          <td><a href="comments.php?reply=<?php echo $post_id; ?>"><i class="fa fa-reply text-info"></i></a></td>
          <td><a href="comments.php?del=<?php echo $id; ?>"><i class="fa fa-times text-danger"></i></a></td>
        </tr>
        <?php } ?>

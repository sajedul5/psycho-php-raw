...
<div class="comtainer body">
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="Dashboard">
      <h1 class="text-muted"><i class="fa fa-user" ></i>Edit<small> User Details</small></h1>
      <hr>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#"><i class="fa fa-tachometer" ></i>Dashboard</a></li>
        <li class="breadcrumb-item active"><i class="fa fa-user" ></i>Edit User</li>
      </ol>
...
<!--form /table-->
              <?php
                if(isset($_POST['add-user'])){
                  ...
                  role='$role',image='$file',details='$details' WHERE id='$edit_id'";
         ...
         <div class="input-group input-group-lg">
           ...
           data-validation="length alphanumeric" data-validation-length="3-12"
    		 data-validation-error-msg="Must Be Alphanumeric & Between 3-12 chars." name="uid" value="<?php echo $e_username; ?>">
              ...
              <div class="form-group">
                <label for="" class="lead"><b>Role</b></label>
                <select class="form-control form-control-lg" name="role">

                <option <?php if($e_role == 'admin'){echo "selected";} ?> value="admin">Admin</option>
                <option <?php if($e_role == 'psychologist'){echo "selected";} ?>value="psychologist">Psychologist</option>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
            <input type="submit" class="btn btn-outline-info btn-lg btn-block" value="Update User" name="add-user">
          </div>
          </form>

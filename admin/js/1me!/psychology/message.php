...
<!--form /table-->
 ...
 if(mysqli_num_rows($result) > 0){
   $row =mysqli_fetch_array($result);
    ...
    $query ="SELECT * FROM message where psy_id =$row[0] ORDER BY msg_id DESC";
    ...
    <table class="table table-hover table-striped text-muted">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="message.php?reply=<?php echo $msg_id; ?>"><i class="fa fa-reply text-info"></i></a></td>
